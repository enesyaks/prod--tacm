...
const DEFAULT_EMAIL_TEMPLATES = {
  ...
  ticket_resolved: {
    ...
    bodyHtml:
      ...
      + '<p style="margin:0 0 14px;color:#64748b;font-size:13px">One star is poor, five is excellent. You can add a note on the next screen. '
      + 'The link can be used once, within 30 days.</p>'
    ...
    bodyText:
      ...
      + '(The link can be used once, within 30 days.)\n'
      + '  1 star  {{csatUrl}}?r=1\n'
      + '  2 stars {{csatUrl}}?r=2\n'
      + '  3 stars {{csatUrl}}?r=3\n'
      + '  4 stars {{csatUrl}}?r=4\n'
